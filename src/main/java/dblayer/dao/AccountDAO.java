...
public class AccountDAO {
	...
	public List<Account> getAccounts(Long userId, Long accountNumber, Long branchId, Long accountCreated,
		...
		try {
			...
			List<Account> accounts = SQLHelper.get(criteria);

			logger.info("Fetched {} accounts successfully.", accounts.size());
			return accounts;
		} catch (Exception e) {
	...
	public void removeAccount(Long accountId) throws CustomException {
